...
export class PagesComponent implements OnInit {
  ...
  constructor(public appSettings: AppSettings, public router: Router,
    private menuService: MenuService, private commonService: CommonService) {
  ...
  ngOnInit() {
    ...
    // this.commonService.getDate({ FIRM_ID: this.userdata['firmID'], BRANCH_ID: this.userdata['branchID'], USER_ID: this.userdata['empCode'] })
    //   .subscribe(result => {

    //     let date = result['curDate'].split('/');
    //     this.sysDate = 'Date: ' + date[0] + '-' + date[1] + '-' + date[2]
    //   })


    this.commonService.getUserCredentials();
