...
export class AccountStatementComponent implements OnInit {
  ...
  constructor(public appSettings: AppSettings, private reportService: ReportsService, private dialog: MatDialog) {
    this.settings = this.appSettings.settings;
  }

  ngOnInit() { this.resetValues(); }
  ...
  getLoanDetails(loanID) {
    ...
    this.reportService.getAccountStatementReport({ loanID: loanID })
      ...
      }, err => { console.log(err); this.settings.loadingSpinner = false; })
  }
