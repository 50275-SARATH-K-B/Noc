...
@Component({
  selector: 'app-eligibility-update',
  templateUrl: './eligibility-update.component.html',
  styleUrls: ['./eligibility-update.component.scss']
})
export class EligibilityUpdateComponent implements OnInit {
  @ViewChild('document')
