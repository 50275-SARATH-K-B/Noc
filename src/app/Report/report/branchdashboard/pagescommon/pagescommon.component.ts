...
import {  ViewChild, HostListener, ViewChildren, QueryList } from '@angular/core';
...
@Component({
  selector: 'app-pagescommon',
  templateUrl: './pagescommon.component.html',
  styleUrls: ['./pagescommon.component.scss'],
  providers: [MenuService]

})
export class PagescommonComponent implements OnInit {
  sysDate: any;
  ...
  constructor(private authenticationService: AuthenticationService,public appSettings: AppSettings, public router: Router,
